...
Another alternative to the [uv Way](/cafe/installation/uv_way/), for a
downloaded copy of CAFE. Like Pixi, Conda builds an isolated environment with
the **correct Python (3.12)** from `cafe.yaml`, so you don't need Python
