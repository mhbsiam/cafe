...
You can skip the download entirely and install CAFE as a global `cafe` command
with uv — see the [uv Way](/cafe/installation/uv_way/). The steps below are for
the Pixi or Conda setup from a downloaded copy.
:::
