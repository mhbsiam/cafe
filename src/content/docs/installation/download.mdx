...
sidebar:
    ...
    label: Download
---
:::tip[Prefer a one-line install?]
If you have Python 3.12, you can skip the download entirely and install CAFE as
a global `cafe` command with pipx — see the [pipx Way](/cafe/installation/pipx_way/).
The steps below are for the Pixi or Conda setup from a downloaded copy.
:::
