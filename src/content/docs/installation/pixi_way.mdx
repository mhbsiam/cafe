...
This is the most reliable way to set up CAFE. Pixi creates an isolated
environment and installs the **correct Python (3.12)** and every dependency for
you — so you don't need Python installed on your machine beforehand.
